...
name: inspect
description: >
  Используй этот скилл для анализа и инспекции любого объекта 1С из XML-выгрузки:
  ...
  Также используй как подготовительный шаг перед любой модификацией объекта.
  Не используй для модификации — для изменений используй соответствующие edit/compile скиллы.
argument-hint: >
...
```powershell
powershell.exe -File scripts/role-info.ps1 -RightsPath <path> -OutFile <output.txt>
```
