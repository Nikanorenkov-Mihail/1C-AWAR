...
Процедура СБ_ДинамическийСписокФильтрыПриАктивизацииСтроки(Элемент)
	...
	#Вставка
	ИначеЕсли Элемент.Имя = "КатегорииМатериалов" И Элементы.СтраницыТипФильтра.ТекущаяСтраница <> Элементы.СтраницаТоварныеКатегории Тогда
		Возврат;
	#КонецВставки
	...
	Иначе
		...
		#Вставка
		ИначеЕсли Элемент.Имя = "КатегорииМатериалов" И ТекущееЗначениеФильтра = Элементы.ТоварныеКатегории.ТекущаяСтрока Тогда
			Возврат;
		#КонецВставки
